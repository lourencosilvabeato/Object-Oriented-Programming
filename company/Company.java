...
public interface Company {
	 ...
	 */
	boolean isStaffMember(String email);
	 ...
	 */
	boolean isHost(String email, LocalDateTime date);
	 ...
	 * @param email: user's email.
	 * @param date: event's date.
	 * @pre email != null && invitedEmail != null && date != null.
	 * @return true if the user has already been invited, false otherwise.
	 */
	boolean alreadyHasSameEvent(String invitedEmail, String email, LocalDateTime date);
	 ...
	 * @return iterator.
	 */
	Iterator<User> getEventInvitedIterator(String email, String eventName)
	 ...
	 */
	int getUserStatus(String email, String eventName, User user);
